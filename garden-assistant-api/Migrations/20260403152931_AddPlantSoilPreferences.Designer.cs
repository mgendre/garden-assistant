...
namespace GardenAssistant.Migrations
{
    ...
    [Migration("20260403152931_AddPlantSoilPreferences")]
    partial class AddPlantSoilPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GardenAssistant.Data.Entities.Plant", b =>
                {
                    ...
                    b.Property<decimal?>("OptimalPhMax")
                        ...
                        .HasColumnName("optimal_ph_max");

                    b.Property<decimal?>("OptimalPhMin")
                        .HasColumnType("decimal(3,1)")
                        .HasColumnName("optimal_ph_min");
            ...
            modelBuilder.Entity("GardenAssistant.Data.Entities.PlantSoilType", b =>
                {
                    b.Property<Guid>("PlantId")
                        .HasColumnType("uuid")
                        .HasColumnName("plant_id");
                    ...
                    b.HasKey("PlantId", "SoilType")
                        .HasName("pk_plant_soil_types");

                    b.ToTable("plant_soil_types", (string)null);
                });
            ...
            modelBuilder.Entity("GardenAssistant.Data.Entities.PlantSoilType", b =>
                {
                    b.HasOne("GardenAssistant.Data.Entities.Plant", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plant_soil_types_plants_plant_id");
                });
